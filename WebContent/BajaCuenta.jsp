...
<div class="input-group mb-3">
  <div class="input-group-prepend">
	...
	<span class="input-group-text" id="basic-addon1">$</span><input type="text" name="txtNroCliente" class="form-control" placeholder="Ej: 0202215151" aria-label="Username" aria-describedby="basic-addon1">
...
<label>Busqueda por Apellido: </label> 	
<div class="input-group mb-3">
  <div class="input-group-prepend">
  </div>
	<span class="input-group-text" id="basic-addon1">$</span><input type="text" name="txtApellido" class="form-control" placeholder="Ej: Cibrian" aria-label="Username" aria-describedby="basic-addon1">
	<input type="submit" name="btnAceptar" value="Aceptar">
</div><br>
